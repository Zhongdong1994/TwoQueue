...
public class TwoQueue {
    public static void main(String[] args) {
        ...
        for(int j=0;j<6;j++){
            matrix[j]=matrix[j]/computationNum;
            System.out.println( matrix[j]);
        }


    }
    public static double[] twoQueue()
    {
    ...
    static double[] findAvgTime(Jobs jobs1[], int n, Jobs request2[], int m, int threshold,double timeInterval, double originalTime){
        ...
        double jobWaitingTime1[]=new double[n], jobSystemTime1[]=new double[n],jobFinishTime1[]=new double[n];
        double jobTotalWaitingTime1 = 0, jobTotalSystemTime1 = 0;

        double requestWaitingTime2[]=new double[m], requestSystemTime2[]=new double[m],requestFinishTime2[]=new double[m];
        double requestTotalWaitingTime2 = 0, requestTotalSystemTime2 = 0;
